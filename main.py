    ...
    categories = [
        {
            ...
            "etf_list": [
                ...
                ("229200.KS", "KODEX 코스닥150", "코스닥 150 지수 추종 (국내 인기 상위)"),
                ("459580.KS", "KODEX CD금리액티브", "금리형 ETF (파킹통장 대체형 인기 1위)"),
                ("381170.KS", "TIGER 미국테크TOP10", "미국 빅테크 우량주 10개 집중 투자"),
                ("465320.KS", "TIGER 미국테크TOP10+10%프리미엄", "빅테크 투자 + 월배당 커버드콜 전략"),
                ("371460.KS", "TIGER 차이나전기차", "중국 전기차/배터리 밸류체인 테마")
            ]
        },
        {
            "id": "us",
...
<urlset xmlns="http://www.sitemaps.org/schemas/sitemap/0.9"
    ...
    <url>
        <loc>{base_url}/per-calculator</loc>
        <lastmod>{today}</lastmod>
        <changefreq>weekly</changefreq>
        <priority>0.8</priority>
    </url>
    <url>
        <loc>{base_url}/target-price-calculator</loc>
        <lastmod>{today}</lastmod>
        <changefreq>weekly</changefreq>
        <priority>0.8</priority>
    </url>
    <url>
        <loc>{base_url}/compound-calculator</loc>
        <lastmod>{today}</lastmod>
        <changefreq>weekly</changefreq>
        <priority>0.8</priority>
    </url>
    <url>
        <loc>{base_url}/dividend-calculator</loc>
        <lastmod>{today}</lastmod>
        <changefreq>weekly</changefreq>
        <priority>0.8</priority>
    </url>
    <url>
        <loc>{base_url}/bep-calculator</loc>
        <lastmod>{today}</lastmod>
        <changefreq>weekly</changefreq>
        <priority>0.8</priority>
    </url>
